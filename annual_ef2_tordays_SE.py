...
daterange = pd.date_range(alltor1.time_1,alltor1.time_2,freq='D')
tor = alltor1.severe.set_index('UTC_time').index.map(lambda t: t.date()).unique()
...
daterange = pd.date_range(alltor2.time_1,alltor2.time_2,freq='D')
tor = alltor2.severe.set_index('UTC_time').index.map(lambda t: t.date()).unique()
...
daterange = pd.date_range(alltor3.time_1,alltor3.time_2,freq='D')
tor = alltor3.severe.set_index('UTC_time').index.map(lambda t: t.date()).unique()
...
daterange = pd.date_range(alltor4.time_1,alltor4.time_2,freq='D')
tor = alltor4.severe.set_index('UTC_time').index.map(lambda t: t.date()).unique()
...
daterange = pd.date_range(alltor5.time_1,alltor5.time_2,freq='D')
tor = alltor5.severe.set_index('UTC_time').index.map(lambda t: t.date()).unique()
...
daterange = pd.date_range(alltor6.time_1,alltor6.time_2,freq='D')
tor = alltor6.severe.set_index('UTC_time').index.map(lambda t: t.date()).unique()
...
daterange = pd.date_range(alltor7.time_1,alltor7.time_2,freq='D')
tor = alltor7.severe.set_index('UTC_time').index.map(lambda t: t.date()).unique()
...
daterange = pd.date_range(alltor8.time_1,alltor8.time_2,freq='D')
tor = alltor8.severe.set_index('UTC_time').index.map(lambda t: t.date()).unique()
...
daterange = pd.date_range(alltor9.time_1,alltor9.time_2,freq='D')
tor = alltor9.severe.set_index('UTC_time').index.map(lambda t: t.date()).unique()
...
daterange = pd.date_range(alltor10.time_1,alltor10.time_2,freq='D')
tor = alltor10.severe.set_index('UTC_time').index.map(lambda t: t.date()).unique()
...
daterange = pd.date_range(alltor11.time_1,alltor11.time_2,freq='D')
tor = alltor11.severe.set_index('UTC_time').index.map(lambda t: t.date()).unique()
...
daterange = pd.date_range(alltor12.time_1,alltor12.time_2,freq='D')
tor = alltor12.severe.set_index('UTC_time').index.map(lambda t: t.date()).unique()
...
plt.title('a) Dec (E)F2+ Southeast Tornadoes and NDJ ONI',fontsize=18)
...
plt.title('b) Jan (E)F2+ Southeast Tornado Days and DJF ONI',fontsize=18)
...
plt.title('c) Feb (E)F2+ Southeast Tornado Days and JFM ONI',fontsize=18)
...
plt.title('d) Mar (E)F2+ Southeast Tornado Days and FMA ONI',fontsize=18)
...
#ticks_cb = ['0','100%','200%','300%','400%','500%','600%','700%','800%']
#ax5.set_xticklabels(ticks_cb, fontsize=12, alpha=0)
...
plt.title('e) Apr (E)F2+ Southeast Tornado Days and MAM ONI',fontsize=18)
...
plt.title('f) May (E)F2+ Southeast Tornado Days and AMJ ONI',fontsize=18)
...
plt.title('g) Jun (E)F2+ Southeast Tornado Days and MJJ ONI',fontsize=18)
...
plt.title('h) Jul (E)F2+ Southeast Tornado Days and JJA ONI',fontsize=18)
...
plt.title('i) Aug (E)F2+ Southeast Tornado Days and JAS ONI',fontsize=18)
...
ticks_cb = ['0','100%','200%','300%','400%','500%','600%','700%']
...
plt.title('j) Sep (E)F2+ Southeast Tornado Days and ASO ONI',fontsize=18)
...
plt.title('k) Oct (E)F2+ Southeast Tornado Days and SON ONI',fontsize=18)
...
plt.title('l) Nov (E)F2+ Southeast Tornado Days and OND ONI',fontsize=18)
