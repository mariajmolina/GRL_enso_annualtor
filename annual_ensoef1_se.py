...
plt.title('a) Dec (E)F1+ Southeast Tornadoes and NDJ ONI',fontsize=18)
...
plt.title('b) Jan (E)F1+ Southeast Tornadoes and DJF ONI',fontsize=18)
...
plt.title('c) Feb (E)F1+ Southeast Tornadoes and JFM ONI',fontsize=18)
...
plt.title('d) Mar (E)F1+ Southeast Tornadoes and FMA ONI',fontsize=18)
...
plt.title('e) Apr (E)F1+ Southeast Tornadoes and MAM ONI',fontsize=18)
...
plt.title('f) May (E)F1+ Southeast Tornadoes and AMJ ONI',fontsize=18)
...
plt.title('g) Jun (E)F1+ Southeast Tornadoes and MJJ ONI',fontsize=18)
...
plt.title('h) Jul (E)F1+ Southeast Tornadoes and JJA ONI',fontsize=18)
...
plt.title('i) Aug (E)F1+ Southeast Tornadoes and JAS ONI',fontsize=18) 
...
plt.title('j) Sep (E)F1+ Southeast Tornadoes and ASO ONI',fontsize=18)
...
plt.title('k) Oct (E)F1+ Southeast Tornadoes and SON ONI',fontsize=18)
...
plt.title('l) Nov (E)F1+ Southeast Tornadoes and OND ONI',fontsize=18)
