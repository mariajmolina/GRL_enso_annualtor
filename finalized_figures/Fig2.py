...
data_neut2 = np.divide(data_neut2,8)
data_nino2 = np.divide(data_nino2,8)
data_nina2 = np.divide(data_nina2,8)

cumstp_neut2 = data_neut2.cumsum('dayofyear', skipna=True)
cumstp_nino2 = data_nino2.cumsum('dayofyear', skipna=True)
cumstp_nina2 = data_nina2.cumsum('dayofyear', skipna=True)
'''
'''
data_neut2 = data_neut.sum(['x','y'], skipna=True)
data_nino2 = data_nino.sum(['x','y'], skipna=True)
...
plt.savefig('wut_5ss.eps', bbox_inches='tight', dpi=200)
