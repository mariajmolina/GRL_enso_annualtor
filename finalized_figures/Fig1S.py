...
ax10.set_xticks(ax10.get_xticks()[::4])
...
ax10.set_xlabel('% EF2+ Climatological Frequency',fontsize=16)
...
ax12.set_xticks(ax12.get_xticks()[::4])
...
ax12.set_xlabel('% EF2+ Climatological Frequency',fontsize=16)
