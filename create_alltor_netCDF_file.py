...
filename = 'tors_5316_ef1_obs'
concat_data.to_netcdf(path='/storage/timme1mj/maria_pysplit/'+filename)
#data_latlon.to_netcdf(path='/storage/timme1mj/maria_pysplit/tor_grid_latlon_30km')
...
exit_data = np.zeros(aggregate_grid[:31,:,:].shape)
exit_time = pd.date_range('2016-12-01','2016-12-31',freq='D')
exit_dat = xr.Dataset({'grid':(['time','y','x'],exit_data)}, \
                       coords={'time':exit_time}) 
...
Tors = Tors[Tors['slat']!=0]
Tors = Tors[Tors['slon']!=0]
Tors = Tors[Tors['slat']>=25]
Tors = Tors[Tors['slat']<=37]
Tors = Tors[Tors['slon']>=-93]
Tors = Tors[Tors['slon']<=-70]
