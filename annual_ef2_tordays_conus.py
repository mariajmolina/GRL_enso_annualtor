...
plt.title('a) Dec (E)F2+ CONUS Tornado Days and NDJ ONI',fontsize=18)
...
plt.title('b) Jan (E)F2+ CONUS Tornado Days and DJF ONI',fontsize=18)
...
plt.title('c) Feb (E)F2+ CONUS Tornado Days and JFM ONI',fontsize=18)
...
plt.title('d) Mar (E)F2+ CONUS Tornado Days and FMA ONI',fontsize=18)
...
plt.title('e) Apr (E)F2+ CONUS Tornado Days and MAM ONI',fontsize=18)
...
plt.title('f) May (E)F2+ CONUS Tornado Days and AMJ ONI',fontsize=18)
...
plt.title('g) Jun (E)F2+ CONUS Tornado Days and MJJ ONI',fontsize=18)
...
plt.title('h) Jul (E)F2+ CONUS Tornado Days and JJA ONI',fontsize=18)
...
plt.title('i) Aug (E)F2+ CONUS Tornado Days and JAS ONI',fontsize=18)
...
ticks_cb = ['0','50%','100%','150%','200%','250%','300%','350%','400%','450%']
...
plt.title('j) Sep (E)F2+ CONUS Tornado Days and ASO ONI',fontsize=18)
...
plt.title('k) Oct (E)F2+ CONUS Tornado Days and SON ONI',fontsize=18)
...
plt.title('l) Nov (E)F2+ CONUS Tornado Days and OND ONI',fontsize=18)
