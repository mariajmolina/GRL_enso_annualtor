...
p5 = ax1.fill_between(range(0,len(tors_low1)),tors_low1,tors_high1,color='grey',linewidth=1.0,alpha=0.5)
...
p5 = ax2.fill_between(range(0,len(tors_low2)),tors_low2,tors_high2,color='grey',linewidth=1.0,alpha=0.5)
...
p5 = ax3.fill_between(range(0,len(tors_low3)),tors_low3,tors_high3,color='grey',linewidth=1.0,alpha=0.5)
...
p5 = ax4.fill_between(range(0,len(tors_low4)),tors_low4,tors_high4,color='grey',linewidth=1.0,alpha=0.5) 
...
p5 = ax9.fill_between(range(0,len(stp_low4)),stp_low4,stp_high4,color='grey',linewidth=1.0,alpha=0.5)
...
p5 = ax5.fill_between(range(0,len(torday_low1)),torday_low1,torday_high1,color='grey',linewidth=1.0,alpha=0.5)
...
p5 = ax6.fill_between(range(0,len(torday_low2)),torday_low2,torday_high2,color='grey',linewidth=1.0,alpha=0.5)
...
p5 = ax7.fill_between(range(0,len(torday_low3)),torday_low3,torday_high3,color='grey',linewidth=1.0,alpha=0.5)
...
p5 = ax8.fill_between(range(0,len(torday_low4)),torday_low4,torday_high4,color='grey',linewidth=1.0,alpha=0.5) 
...
p5 = ax10.fill_between(range(0,len(stpse_low4)),stpse_low4,stpse_high4,color='grey',linewidth=1.0,alpha=0.5)
