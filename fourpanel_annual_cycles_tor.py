...
p1, = plt.plot(range(0,total_days),Gauss_SmoothTELN1/np.sum(Gauss_SmoothTELN1),'r-',linewidth=2.0)
p2, = plt.plot(range(0,total_days),Gauss_SmoothTLN1/np.sum(Gauss_SmoothTLN1),'b-',linewidth=2.0)
p3, = plt.plot(range(0,total_days),Gauss_SmoothTN1/np.sum(Gauss_SmoothTN1),'k-',linewidth=2.0)    
p4, = plt.plot(range(0,total_days),Gauss_SmoothAN1/np.sum(Gauss_SmoothAN1),'--',color='grey',linewidth=2.0)  
...
plt.title('a) Annual Cycle of CONUS (E)F1+ Tornado Reports')
...
p1, = plt.plot(range(0,total_days),Gauss_SmoothTELN2/np.sum(Gauss_SmoothTELN2),'r-',linewidth=2.0)
p2, = plt.plot(range(0,total_days),Gauss_SmoothTLN2/np.sum(Gauss_SmoothTLN2),'b-',linewidth=2.0)
p3, = plt.plot(range(0,total_days),Gauss_SmoothTN2/np.sum(Gauss_SmoothTN2),'k-',linewidth=2.0)    
p4, = plt.plot(range(0,total_days),Gauss_SmoothAN2/np.sum(Gauss_SmoothAN2),'--',color='grey',linewidth=2.0)  

plt.ylabel('Fraction of Tornado Reports ((E)F2+)')
plt.xlabel('Day of Year')
...
tick_lbls = ['Jan 1','Feb 19','Apr 10','May 30','Jul 19','Sep 7','Oct 27','Dec 16']
plt.xticks(tick_locs, tick_lbls)
plt.title('a) Annual Cycle of CONUS (E)F2+ Tornado Reports')
...
p1, = plt.plot(range(0,total_days),Gauss_SmoothTELN3/np.sum(Gauss_SmoothTELN3),'r-',linewidth=2.0)
p2, = plt.plot(range(0,total_days),Gauss_SmoothTLN3/np.sum(Gauss_SmoothTLN3),'b-',linewidth=2.0)
p3, = plt.plot(range(0,total_days),Gauss_SmoothTN3/np.sum(Gauss_SmoothTN3),'k-',linewidth=2.0)    
p4, = plt.plot(range(0,total_days),Gauss_SmoothAN3/np.sum(Gauss_SmoothAN3),'--',color='grey',linewidth=2.0)  
...
tick_lbls = ['Jan 1','Feb 19','Apr 10','May 30','Jul 19','Sep 7','Oct 27','Dec 16']
plt.xticks(tick_locs, tick_lbls)
plt.title('a) Annual Cycle of Southeast (E)F1+ Tornado Reports')
...
p1, = plt.plot(range(0,total_days),Gauss_SmoothTELN4/np.sum(Gauss_SmoothTELN4),'r-',linewidth=2.0)
p2, = plt.plot(range(0,total_days),Gauss_SmoothTLN4/np.sum(Gauss_SmoothTLN4),'b-',linewidth=2.0)
p3, = plt.plot(range(0,total_days),Gauss_SmoothTN4/np.sum(Gauss_SmoothTN4),'k-',linewidth=2.0)    
p4, = plt.plot(range(0,total_days),Gauss_SmoothAN4/np.sum(Gauss_SmoothAN4),'--',color='grey',linewidth=2.0)  
...
tick_lbls = ['Jan 1','Feb 19','Apr 10','May 30','Jul 19','Sep 7','Oct 27','Dec 16']
plt.xticks(tick_locs, tick_lbls)
plt.title('a) Annual Cycle of Southeast (E)F2+ Tornado Reports')
...
ax1.set_ylabel('Fraction of Tornado Reports ((E)F2+)', fontsize=10)
...
ax1.set_title('a) Annual Cycle of CONUS (E)F1+ Tornado Reports')
...
ax2.set_ylabel('Fraction of Tornado Reports ((E)F2+)', fontsize=10)
...
ax2.set_title('b) Annual Cycle of CONUS (E)F2+ Tornado Reports')
...
ax3.set_ylabel('Fraction of Tornado Reports ((E)F2+)', fontsize=10)
...
ax3.set_title('c) Annual Cycle of Southeast (E)F1+ Tornado Reports')
...
ax4.set_ylabel('Fraction of Tornado Reports ((E)F2+)', fontsize=10)
...
ax4.set_title('d) Annual Cycle of Southeast (E)F2+ Tornado Reports')
